...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Biggest Loser Celebration Dialog */}
      <Dialog open={showLoserCelebration} onOpenChange={setShowLoserCelebration}>
        <DialogContent className="max-w-lg border-destructive/50 bg-gradient-to-br from-destructive/20 via-background to-destructive/10">
          {showSuspense ? (
            // Suspense Phase
            ...
            <>
              <DialogHeader className="text-center space-y-3">
                ...
                <DialogTitle className="text-3xl md:text-4xl font-headline text-destructive">
                  BIGGEST LOOOOOSER!
                </DialogTitle>
              </DialogHeader>
