...
export function useCollection<T = any>(
  ...
  if(memoizedTargetRefOrQuery && !(memoizedTargetRefOrQuery as any).__memo) {
    console.warn('The query/reference passed to useCollection was not created with useMemoFirebase. This can lead to performance issues and bugs.', memoizedTargetRefOrQuery);
  }
